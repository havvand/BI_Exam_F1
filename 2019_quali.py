...
sns.histplot(df_2019_quali['q1'], bins=47, ax=axs[0])
sns.histplot(df_2019_quali['q2'], bins=47, ax=axs[1])
sns.histplot(df_2019_quali['q3'], bins=47, ax=axs[2])
...
df_2019_quali = df_2019_quali[((df_2019_quali['q1'].isna()) | ((df_2019_quali['q1'] <= 106000) & (df_2019_quali['q1'] >= 53000))) &
                              ((df_2019_quali['q2'].isna()) | ((df_2019_quali['q2'] <= 106000) & (df_2019_quali['q2'] >= 53000))) &
                              ((df_2019_quali['q3'].isna()) | ((df_2019_quali['q3'] <= 106000) & (df_2019_quali['q3'] >= 53000)))]
df_2019_quali = df_2019_quali[(df_2019_quali['driverId'] != 850) & (df_2019_quali['driverId'] != 851)]

fig, axs = plt.subplots(1, 3, figsize=(30, 20))
sns.histplot(df_2019_quali['q1'], bins=21, ax=axs[0])
sns.histplot(df_2019_quali['q2'], bins=21, ax=axs[1])
sns.histplot(df_2019_quali['q3'], bins=21, ax=axs[2])

# Calculating the IQR for Q1, Q2 and Q3 times
Q1R1_q1 = df_2019_quali['q1'].quantile(0.25)
Q1R1_q3 = df_2019_quali['q1'].quantile(0.75)
iqr_1 = Q1R1_q3 - Q1R1_q1

Q1R2_q1 = df_2019_quali['q2'].quantile(0.25)
Q1R2_q3 = df_2019_quali['q2'].quantile(0.75)
iqr_2 = Q1R2_q3 - Q1R2_q1

Q1R3_q1 = df_2019_quali['q3'].quantile(0.25)
Q1R3_q3 = df_2019_quali['q3'].quantile(0.75)
...
driver_quali_times = df_2019_quali.groupby('driverId')[['driverId', 'raceId', 'q1', 'q2', 'q3']].apply(lambda x: x)
...
race_989 = df_2019_quali[df_2019_quali['raceId'] == 989]
race_990 = df_2019_quali[df_2019_quali['raceId'] == 990]
mean_990 = race_990['q1'].mean()
mean_989 = race_989['q1'].mean()
print('989', mean_989)


mean_q1 = df_2019_quali['q1'].mean()
print('Mean Q1:', mean_q1)
median_q1 = df_2019_quali['q1'].median()
print('Median Q1:', median_q1)
std_deviation_q1 = df_2019_quali['q1'].std()
print('Std Deviation Q1:', std_deviation_q1)
standard_error_q1 = df_2019_quali['q1'].sem()
print('Standard Error:', standard_error_q1)


mean_q2 = df_2019_quali['q2'].mean()
print('Mean Q2:', mean_q2)
median_q2 = df_2019_quali['q2'].median()
print('Median Q2:', median_q2)
std_deviation_q2 = df_2019_quali['q2'].std()
print('Std Deviation Q2:', std_deviation_q2)
standard_error_q2 = df_2019_quali['q2'].sem()
print('Standard Error:', standard_error_q2)


mean_q3 = df_2019_quali['q3'].mean()
print('Mean Q3:', mean_q3)
median_q3 = df_2019_quali['q3'].median()
print('Median Q3:', median_q3)
std_deviation_q3 = df_2019_quali['q3'].std()
print('Std Deviation Q3:', std_deviation_q3)
standard_error_q3 = df_2019_quali['q3'].sem()
print('Standard Error:', standard_error_q3)

race_ids = df_2019_quali['raceId'].unique()
driver_ids = df_2019_quali['driverId'].unique()
...
df_2019_quali = df_2019_quali.dropna(subset=['q1'])
#%%
df_2019_quali['q1'] = pd.to_numeric(df_2019_quali['q1'], errors='coerce')


# Calculate the KDE
kde = gaussian_kde(df_2019_quali['q1'])
kde.set_bandwidth(bw_method=kde.factor / 2)
x = np.linspace(df_2019_quali['q1'].min(), df_2019_quali['q1'].max(), 1000)
...
sns.histplot(df_2019_quali['q1'], bins=20, kde=True)
...
reshape = np.reshape(df_2019_quali['q1'].values, (-1, 1))
kmeans.fit(reshape)
df_2019_quali['cluster'] = kmeans.predict(reshape)

silhouette_avg = silhouette_score(reshape, df_2019_quali['cluster'])
print('Silhouette Score:', silhouette_avg)

chi_score = calinski_harabasz_score(reshape, df_2019_quali['cluster'])
print('Calinski Harabasz Score:', chi_score)

db_score = davies_bouldin_score(reshape, df_2019_quali['cluster'])
print('Davies Bouldin Score:', db_score)

# Plot the clusters
plt.scatter(df_2019_quali['q1'], df_2019_quali['q2'], c=df_2019_quali['cluster'], cmap='viridis')
plt.xlabel('Q1 Time')
plt.ylabel('Q2 Time')
...
trace = go.Scatter(
    ...
    marker = dict(
        size = 10,
        color = df_2019_quali['cluster'], # set color equal to a variable
        colorscale = 'Viridis', # one of plotly colorscales
        showscale = True
    ),
    text =df_2019_quali.raceId.astype(str) + '<br>' + 'DriverID: ' + df_2019_quali.driverId.astype(str) # This will be displayed when you hover over a point
)
...
trace2 = go.Scatter(
    ...
    text =df_2019_quali.raceId.astype(str) + '<br>' + 'DriverID: ' + df_2019_quali.driverId.astype(str) + '<br>' + 'Q3', # This will be displayed when you hover over a point
    name = 'Q1 vs Q3'
)
